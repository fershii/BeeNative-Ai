class Tetragona extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
    <style>
  ...
  <p class="text-center text-[#FAE45E] text-5xl font-semibold justify-center mb-4">Género Tetragona</p>
  ...
  <section class="bg-[#283B0A] flex items-center justify-center min-h-screen p-2">
    ...
    <div class="flex gap-6 w-full max-w-6xl h-[500px]">
      ...
      >
        <div>
          ...
          <p id="info-descripcion" class="info-field text-sm text-gray-700 leading-relaxed mb-3">
            Abeja de cuerpo oscuro y alas transparentes. Forma colonias organizadas y suele ser menos agresiva que las especies del género Trigona.
          </p>
          ...
          <div class="mt-3 space-y-2">
            ...
            <div>
              ...
              Centroamérica y regiones tropicales de Sudamérica.
              </p>
            </div>
            <div>
              ...
              Participa en la polinización de ecosistemas tropicales y cultivos locales.
              </p>
            </div>
            <div>
      ...
      <div id="panel-principal" class="w-1/2 h-full flex items-center justify-center">
        ...
        <div
          id="card-A"
          onclick="abrirImagen(this); window.tetragonaSeleccionar(this, event)"
          data-title="Tetragona perangulata"
          data-desc="Abeja de cuerpo oscuro y alas transparentes. Forma colonias organizadas y suele ser menos agresiva que las especies del género Trigona."
          data-size="5-7 mm."
          data-distribution="Centroamérica y regiones tropicales de Sudamérica."
          data-importance="Participa en la polinización de ecosistemas tropicales y cultivos locales."
        ...
        >
          <img src="/img/Tetragona perangulata.jpg" alt="Tetragona perangulata" class="w-full h-full object-cover rounded-lg">
        </div>
      ...
      <div id="columna-lateral" class="w-1/4 h-full flex flex-col gap-3">
        ...
        <div
          id="card-B"
          onclick="window.tetragonaSeleccionar(this, event)"
          data-title="-"
          data-desc="-"
          data-size="-"
          data-distribution="-"
    ...
    if (!window.tetragonaSeleccionar) {
      window.tetragoniscaSeleccionar = function(tarjetaClickeada, event) {
        ...
        const root = tarjetaClickeada.closest('tetragona-section');
        if (!root) return;
...
customElements.define('tetragona-section', Tetragona);